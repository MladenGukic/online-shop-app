<template>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Shop Name" v-model="form.name" required>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Logo URL" v-model="form.logoUrl" required>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="exampleFormControlSelect1" v-model="form.manager_id">
      <option v-for="manager in freeManagers" :key="manager.id" :value="manager.id">{{manager.first_name}}</option>
    </select>
  </div>
